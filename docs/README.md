...
|---|---|---|
| `04-api-specification.md` | Repository-aligned contract after DOC1C1 correction | Normative current API summary at the audited source snapshot |
| `04-api-route-inventory.md` | Corrected exhaustive inventory (288 routes) | Normative implemented route evidence after independent DOC1 review |
...
Production/API audit SHA: `c8ba9e87a83b5c19ad574ef7f98f3e5340bd56a2`. DOC1 (`23.1B1C6D1DOC1`) produced the first six-file inventory but failed independent accuracy review; DOC1C1 is the corrective pass and does not change production code.

> The latest accepted repository implementation and tests are authoritative for current behavior. Documentation is normative for future work only within the audited source snapshot and explicit future-scope classifications, after reconciliation and approval.
