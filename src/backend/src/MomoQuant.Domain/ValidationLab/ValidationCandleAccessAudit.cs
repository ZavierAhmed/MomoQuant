...
public class ValidationCandleAccessAudit : Entity
{
    ...
    /// <summary>
    /// Monotonic sequence within the scope execution, assigned at event creation.
    /// </summary>
    public long ScopeSequenceNumber { get; set; }
