...
public sealed class StrategyDataRequirementService : IStrategyDataRequirementService
{
    ...
    private static StrategyDataRequirementDto BuildRequirement(StrategyEntity strategy)
    {
        ...
        return new StrategyDataRequirementDto
        {
            ...
            SupportsValidation = StrategyCapabilityPolicy.SupportsValidation(strategy.Code),
            SupportsOptimization = StrategyCapabilityPolicy.SupportsOptimization(strategy.Code),
            SupportsStrategyLab = StrategyCapabilityPolicy.SupportsStrategyLab(strategy.Code),
